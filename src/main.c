...
double get_covalent_radius(const char *element) {
    if (strcmp(element, "H") == 0) return 0.31;
    if (strcmp(element, "C") == 0) return 0.76;
    if (strcmp(element, "N") == 0) return 0.71;
    if (strcmp(element, "O") == 0) return 0.66;
    if (strcmp(element, "Pd") == 0) return 1.39;
    return 1.00; 
}
